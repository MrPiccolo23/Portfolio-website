...
const Navbar = () => {
    ...
    px-4 text-white bg-black fixed'  >
            <Link to='home' smooth duration={500} offset={-70} spy={true} activeClass="active">
                <div>
                    <h1 className='text-5xl font-signature ml-2 cursor-pointer'>Sattar</h1>
                </div>
            </Link>
            <ul className='hidden md:flex'>
                ...
                >
                    <Link to={link} smooth duration={500} offset={-70} spy={true} activeClass="active">
                    {link}
                    </Link>
                </li>
                ))}
